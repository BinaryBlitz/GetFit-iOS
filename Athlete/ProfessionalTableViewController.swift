...
class ProfessionalTableViewController: UITableViewController {
  ...
  override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
    ...
    case 0 where (indexPath as NSIndexPath).row == 0:
      ...
      return cell
    case 0 where (indexPath as NSIndexPath).row == 1:
  ...
  override func tableView(_ tableView: UITableView, heightForRowAt indexPath: IndexPath) -> CGFloat {
    switch (indexPath as NSIndexPath).section {
    case 0:
      return (indexPath as NSIndexPath).row == 0 ? 320 : 40
    case 1:
  ...
  override func tableView(_ tableView: UITableView, estimatedHeightForRowAt indexPath: IndexPath) -> CGFloat {
    switch (indexPath as NSIndexPath).section {
    case 0:
      return (indexPath as NSIndexPath).row == 0 ? 350 : 40
    case 1:
      return 400
    default:
      return 0
